  ...
  <div id="aCoursesList" class="bg-fa of">
    ...
    <section class="container">
      <section class="path-wrap txtOf hLh30">
        <li>
          <a  title href="/" @click="searchAll()" class="c-999 fsize14">首页</a>
          <span>\</span>
          <a  title href="#" @click="one()" class="c-999 fsize14">{{courseWebVo.subjectLevelOne}}</a>
          <span>\</span>
          <a  title href="#" @click="two()" class="c-999 fsize14">{{courseWebVo.subjectLevelTwo}}</a>
          <span>\</span>
                    ...
                    <ul>
                      <li class="unBr">
                        <aside class="noter-pic">
                          <img v-if="userInfo.avatar === ''" width="50" height="50" class="picImg" src="~/assets/img/avatar-boy.gif">
                          <img v-else width="50" height="50" class="picImg" :src="userInfo.avatar">
                        </aside>
                        <div class="of">
...
export default {
  ...
  methods: {
    ...
    one() {
      this.$router.push({ name: 'course',params:{oneId:this.courseWebVo.subjectLevelOneId}})
      //this.$router.push({ path: '/course?oneId='+this.courseWebVo.subjectLevelOneId })
    },
    two() {
      this.$router.push({ name: 'course',params:{oneId:this.courseWebVo.subjectLevelOneId,twoId:this.courseWebVo.subjectLevelTwoId}})
      //this.$router.push({ path: '/course?oneId='+this.courseWebVo.subjectLevelOneId+'&twoId='+this.courseWebVo.subjectLevelTwoId })
    },
    initComment(){
    ...
    gotoPage(page){
      ...
      this.comment.teacherId = this.courseWebVo.teacherId
      commentApi.getPageList(page, 4,this.comment.courseId).then(response => {
        this.data = response.data.data
      })
    }
  }
