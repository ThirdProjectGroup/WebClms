  ...
  <div class="in-wrap">
    ...
    <header id="header">
      <section class="container">
        <h1 id="logo">
          <a href="#" title="卓越第三小组">
            <img src="~/assets/img/logo.png" width="50%" alt="卓越第三小组">
          </a>
        </h1>
        <div class="h-r-nsl">
          <ul class="nav">
          ...
          <aside class="h-r-search">
            <form action="#" method="post">
              <label class="h-r-s-box">
                <input type="text" placeholder="输入你想找的内容" name="queryCourse.courseName" value>
      ...
      <section class="container">
        <div class>
          ...
          <ul class="of flink-list">
            <li>
              <a href="http://www.atguigu.com/" title="卓越班" target="_blank">卓越班</a>
            </li>
          </ul>
          <div class="clear"></div>
        </div>
          ...
          <section class="fl col-7">
            <section class="mr20">
              <section class="b-f-link">
                ...
                <span>Email：1260388182@.qqcom</span>
              </section>
              <section class="b-f-link mt10">
                <span>©版权均归卓越班所有 京ICP备17055252号</span>
              </section>
            </section>
          </section>
